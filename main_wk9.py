...
#                     commsList[ANDROID].write('{ "robot": {x:'+ response['end_state'][0] +',y:'+response['end_state'][1]+', angle:'+response['end_state'][2]+'} }') #update after each mvmt based on algo commands
                    #check the angle if its ok
                    received = False
...
#                     y = '3'
#                     angle = '-90'
#                     commsList[ANDROID].write(' { "robot": {"x":'+x+',"y":'+y+', "angle":' +angle +'} }')
#                     testx = '3'
#                     testy = '3'
#                     image_id = '2'
#                     commsList[ANDROID].write('{"image":{"x":' + testx + ',"y": ' + testy + ', "imageID": ' + image_id + '}}')
...
#                         commsList[ANDROID].write('{"image":{"x":' + response['coordinates'][0] + ',"y": ' + response['coordinates'][1] + ', "imageID": ' + image_id + '}}')
